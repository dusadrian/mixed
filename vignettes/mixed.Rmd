...
If performing a mean, for instance, the normal expectation is that value 99 would not play any role in
...
**mixed** should not be necessary, if the design philosophy of these packages would be different. 
...
bytes, and the available 16 bits can fit any number between -32767 to 32767. The numeric tagged value
